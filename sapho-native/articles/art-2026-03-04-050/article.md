...
artifact_minted_at_utc: '2026-03-30T06:23:49Z'
evidence_count: 5
claim_count: 3
publication_status: published
imported_from_runtime_article_id: art-2026-03-04-050
imported_from_runtime_last_stage: facts
imported_from_runtime_filter_state: pending
curator_reason: 'This blog post describes an experiment where Cloudflare ran 1,000
  popular NPM packages in their Workers environment, reporting that only 1.5% failed
  to work. This provides concrete experimental data on the platform''s Node.js compatibility,
  which is a criterion for keeping.

  Limits: The excerpt is partial and the full results of the experiment, including
  specific package names or detailed failure analyses, may be omitted. The focus is
  on the platform''s capabilities rather than a deep dive into AI agent findings.'
curated_at_utc: '2026-03-30T06:21:52Z'
curator_mode: agent
extracted_at_utc: '2026-03-30T06:23:49Z'
extractor_mode: agent
findings_mode: agent
summary_mode: agent
artifact_publication_alias: '20260304050'
artifact_publication_status: published
artifact_publication_minted_at_utc: '2026-03-30T06:23:49Z'
artifact_publication_published_at_utc: '2026-03-30T07:00:03Z'
